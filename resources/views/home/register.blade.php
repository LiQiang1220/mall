...
<div class="head-background">
	...
	<div class="wp1 relative">
		<div class="register-content" id="registerForm">
			...
			<div class="login r">
				已有华为帐号
				<a href="#" class="login-a" title="登录">登录</a><span class="ar-eg-opposite">&gt;</span>
			</div>
...
<!-- 
				<div class="input-container" id="phoneInputDiv-box">
					<div class="l input-left">
						...
						<div id="input_languageCode">手机号</div>
					</div>
 ...
 -->
				...
				<div class="input-container" id="randomCodeDiv">
					...
					<div class="r input-right">
						<img style="height: 40px" src="../../picture/24bf0ec9b4f94a448171625d78038c3d.gif"
							id="randomCodeImg"
							alt="验证码"
