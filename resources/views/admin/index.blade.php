...
<div id="dcWrap"> <div id="dcHead">
 <div id="head">
  <div class="logo"><a href="/admins/index"><img src="/admin/images/dclogo.gif" alt="logo"></a></div>
  <div class="nav">
   <ul>
...
<!-- 左侧开始 -->
 ...
 <ul>
  <li><a href="/admins/system"><i class="system"></i><em>系统设置</em></a></li>
  <li><a href="/admins/nav"><i class="nav"></i><em>自定义导航栏</em></a></li>
  <li><a href="/admins/show"><i class="show"></i><em>首页幻灯广告</em></a></li>
  <li><a href="/admins/page"><i class="page"></i><em>单页面管理</em></a></li>
 </ul>
   <ul>
  <li><a href="/admins/productcategory"><i class="productCat"></i><em>商品分类</em></a></li>
  <li><a href="/admins/product"><i class="product"></i><em>商品列表</em></a></li>
 </ul>
  <ul>
  <li><a href="/admins/articlecategory"><i class="articleCat"></i><em>文章分类</em></a></li>
  <li><a href="/admins/article"><i class="article"></i><em>文章列表</em></a></li>
 </ul>
   <ul class="bot">
  <li><a href="/admins/backup"><i class="backup"></i><em>数据备份</em></a></li>
  <li><a href="/admins/mobile"><i class="mobile"></i><em>手机版</em></a></li>
  <li><a href="/admins/theme"><i class="theme"></i><em>设置模板</em></a></li>
  <li><a href="/admins/manager"><i class="manager"></i><em>网站管理员</em></a></li>
  <li><a href="/admins/managerlog"><i class="managerLog"></i><em>操作记录</em></a></li>
 </ul>
</div></div>
 <div id="dcMain"> <!-- 当前位置 -->
@section("zhuti")
